...
void GameScene::update() 
{
	...
	ImGui::Image((ImTextureID)(intptr_t)systemManager->mGraphicsSystem->m_PhysBloomRenderer.mBloomFBO.mMipChain[0].mTexture, viewportPanelSize, ImVec2(0, 1), ImVec2(1, 0));

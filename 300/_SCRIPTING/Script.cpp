...
//}
//
//void Scripts::AddScript(EntityID id, std::string fileName)
//{
//    Scripts* Scrp = g_engine->entityMgr->GetComponent<Scripts>(id);
//    Script temp;
//    temp.scriptFile = fileName;
//    temp.env = { ScriptingSystem::luaState, sol::create, ScriptingSystem::luaState.globals() };
//    Scrp->scriptsContainer.push_back(temp);
//}
//
//void Scripts::LoadRunScript(EntityID entity)
//{
//    Scripts* scripts = g_engine->entityMgr->GetComponent<Scripts>(entity);
